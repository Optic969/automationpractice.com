...
public class HomePage {
    ...
    public WebElement getSearchField(){
        return Utils.waitForElementPresence(driver,By.xpath("//input[@name='search_query']"),30);
    }
    public WebElement getSearchItem() {
        return Utils.waitForElementPresence(driver, By.xpath("//button[@name='submit_search']"), 30);
    }
}
